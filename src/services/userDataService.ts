...
export async function salvarNotaUsuario(uid:string,tituloNota:string, conteudoNota:String, coords:{ latitude: number; longitude: number }, data: Date| null, notificationId: string | null) {
